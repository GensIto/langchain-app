/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3b44990b3607fa73cde804652a250acd)
// Runtime types generated with workerd@1.20260210.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PROD_SEARCH: VectorizeIndex;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_BROWSER_RENDERING_TOKEN" | "CLOUDFLARE_AI_TOKEN">> {}
}
