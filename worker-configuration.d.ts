/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 938eeb4cad34df6cc87114af04c57f73)
// Runtime types generated with workerd@1.20260210.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EPISODE_DOCS_BUCKET: R2Bucket;
		DB: D1Database;
		VECTORIZE_INDEX: VectorizeIndex;
		EPISODE_VECTORIZE_QUEUE: Queue;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_BROWSER_RENDERING_TOKEN" | "CLOUDFLARE_AI_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
